    ...
    var dt_user = dt_user_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 3,
          render: function (data, type, full, meta) {
            var $departemen = full['departemen'];
            return '<span >' + $departemen + '</span>';
          }
        },
        {
          // User Role
          ...
          render: function (data, type, full, meta) {
            ...
            var roleBadgeObj = {
              ...
              Operator: '<i class="ri-vip-crown-line ri-22px text-primary me-2"></i>',
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return '<span class="text-heading">' + $golongan + '</span>';
          }
        },
        {
          // User Status
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var select = $(
              '<select id="UserPlan" class="form-select text-capitalize"><option value=""> Select Departemen </option></select>'
            )
              .appendTo('.user_plan')
              .on('change', function () {
                var val = $.fn.dataTable.util.escapeRegex($(this).val());
