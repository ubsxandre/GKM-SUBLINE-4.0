...
(function () {
  ...
  if (typeof wizardCreateDeal !== undefined && wizardCreateDeal !== null) {
    ...
    // Wizard steps
    const wizardCreateDealFormStep1 = wizardCreateDealForm.querySelector('#latar_belakang');
    const wizardCreateDealFormStep2 = wizardCreateDealForm.querySelector('#perencanaan_kegiatan');
    const wizardCreateDealFormStep3 = wizardCreateDealForm.querySelector('#target_output');
    const wizardCreateDealFormStep4 = wizardCreateDealForm.querySelector('#detail_personel');
    const wizardCreateDealFormStep5 = wizardCreateDealForm.querySelector('#approval');
    const wizardCreateDealFormStep6 = wizardCreateDealForm.querySelector('#review-complete');
    ...
    // Deal Usage
    const FormValidation6 = FormValidation.formValidation(wizardCreateDealFormStep6, {
      fields: {
        // * Validate the fields here based on your requirements
      },
      plugins: {
    ...
    wizardCreateDealNext.forEach(item => {
      item.addEventListener('click', event => {
        const currentStep = validationStepper._currentIndex;
        ...
        switch (currentStep) {
          ...
          case 4:
            ...
            break;
          case 5:
            // Step terakhir — langsung submit, bukan next
    ...
    wizardCreateDealPrev.forEach(item => {
      item.addEventListener('click', event => {
        ...
        // Pastikan tidak keluar dari step pertama
        if (currentStep > 0) {
