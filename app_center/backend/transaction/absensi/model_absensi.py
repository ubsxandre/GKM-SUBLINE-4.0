...
class TransIzinKeluarMasuk(db.Model):
  """
  Transaksi Izin Keluar Masuk
  """
  __tablename__ = 't_izin_keluar_masuk'
  id = db.Column(db.Integer, primary_key=True)
  nik = db.Column(db.String(100))
  nama = db.Column(db.String(100))
  bagian = db.Column(db.String(100))
  ...
  keperluan = db.Column(db.String(250))
  created_by = db.Column(db.String(100), default='SYSTEM')
  created_date = db.Column(db.DateTime, default=waktu_sekarang)
  status_aktif = db.Column(db.String(2), default='1')
  def to_dict(self):
...
class TransIzinKeluarMasukHistory(db.Model):
  """
  Transaksi Izin Keluar Masuk History
  """
  __tablename__ = 't_izin_keluar_masuk_history'
  __bind_key__ = 'history'
  id = db.Column(db.Integer, primary_key=True)
  id_history = db.Column(db.Integer)
  nik = db.Column(db.String(100))
